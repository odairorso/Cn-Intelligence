...
export default async function handler(req, res) {
  ...
  const publicRoutes = new Set(['health', 'folha-push', 'temp-create-combustivel']);
  ...
  return dbStorage.run(req.authUid, async () => {
    try {
      ...
      switch (route) {
        ...
        case 'temp-create-combustivel': { const m = await import('./temp-create-combustivel.js'); return m.handleCreateCombustivel(req, res); }
