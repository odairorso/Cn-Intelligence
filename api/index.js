...
export default async function handler(req, res) {
  ...
  const publicRoutes = new Set(['health', 'folha-push', 'temp-create-bank']);
  ...
  return dbStorage.run(req.authUid, async () => {
    try {
      ...
      switch (route) {
        ...
        case 'temp-create-bank': { const m = await import('./temp-create-bank.js'); return m.handleCreateBank(req, res); }
